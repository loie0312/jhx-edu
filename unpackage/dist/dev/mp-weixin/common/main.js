...
var _graceChecker = _interopRequireDefault(__webpack_require__(/*! @/utils/graceChecker */ 17));
var _formRuleConfig = _interopRequireDefault(__webpack_require__(/*! @/config/formRule.config.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/*
    ...
    */
_vue.default.prototype.createUrl = function (path, obj) {
  var url = path || '/';
  var paramsStr = '';
...
/*
    ...
    * 例子：{a:1,b:2} => a=1&b=2
    */
_vue.default.prototype.objParseParam = function (obj) {
  var paramsStr = '';
...
/*
    ...
    * 例子：{a:1,b:2} => a=1&b=2
    */
_vue.default.prototype.goto = function () {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  console.log(url);
...
/*
    * 判断用户是否是vip
    */
_vue.default.prototype.isVip = function () {
...
var _base = __webpack_require__(/*! @/utils/base.js */ 8);

var _common = __webpack_require__(/*! @/utils/common.js */ 13);var base = new _base.Base();
var common = new _common.Common();var _default =
{
  onLaunch: function onLaunch() {
    console.log('App Launch');
    if (common.isWechat() && !uni.getStorageSync('accessToken')) {
      base.auth();
    }
...
/* 14 */
/*!****************************************************************!*\
  !*** C:/xcx/jhx/jhx/App.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
