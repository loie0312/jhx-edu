...
/***/ 25:
/*!***************************************************************************!*\
  !*** C:/xcx/jhx/jhx/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***************************************************************************/
...
var _adv = __webpack_require__(/*! @/model/adv.js */ 30);
var _system = __webpack_require__(/*! @/model/system.js */ 31);
...
var _wxqrcode = _interopRequireDefault(__webpack_require__(/*! @/utils/wxqrcode.js */ 34));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var publicModel = new _public.Public();var adv = new _adv.Adv();var system = new _system.System();var product = new _product.Product();var uniGrid = function uniGrid() {__webpack_require__.e(/*! require.ensure | components/uni-grid/uni-grid */ "components/uni-grid/uni-grid").then((function () {return resolve(__webpack_require__(/*! @/components/uni-grid/uni-grid.vue */ 184));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var jhxProductList = function jhxProductList() {__webpack_require__.e(/*! require.ensure | components/jhx-product-list/jhx-product-list */ "components/jhx-product-list/jhx-product-list").then((function () {return resolve(__webpack_require__(/*! @/components/jhx-product-list/jhx-product-list.vue */ 198));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var uniGridItem = function uniGridItem() {__webpack_require__.e(/*! require.ensure | components/uni-grid-item/uni-grid-item */ "components/uni-grid-item/uni-grid-item").then((function () {return resolve(__webpack_require__(/*! @/components/uni-grid-item/uni-grid-item.vue */ 191));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);}; // 二维码生成器
var _default = {
  components: { uniGrid: uniGrid, uniGridItem: uniGridItem, jhxProductList: jhxProductList },
  data: function data() {
    return {
      configData: {},
      banner: [],
  ...
  methods: {
    ...
    getBanner: function getBanner() {
      ...
      adv.getAdv(param, function (data) {
    ...
    getConfig: function getConfig() {var _this2 = this;
      ...
      publicModel.config(param, function (data) {
        ...
        wx.setStorageSync('config', _this2.configData);
      });
    },
    ...
    //画海报
    paintPoster: function paintPoster() {var _this3 = this;
      ...
      then(function (res) {
        ...
        ctx.drawImage(_this3.qrcodeImg, 20, width + 40, 90, 90);
        //画布白色背景
